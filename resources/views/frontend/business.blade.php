        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <p>
                Our Platform is better than Sales Force and had features of Calendly, Sales Force, Infusionsoft, Hootsuite, etc. at one touch of button. Our Platform will help you in managing your Leads, Sales, Schedules, Meeting, Employees and Marketing platforms & Strategies, through:
              </p>
        ...
        <div class="row gy-4 mt-3 portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  <button type="button" onclick="openForm('insurance')" id="myBtn" class=""><i class="bi bi-plus"></i> Get your industry specific platform demo</button>
                </div>
              </div>
            </div>
            ...
            <div class="box-feature">
              ...
              <ul>
                <li>Your dashboard helps in managing or scheduling your tasks, Meetings, Marketing, etc.</li>
                <li>To-Do list will show you everyday (automatically pop out) tasks.</li>
                <li>Leads will be managed according to categories.</li>
              </ul>
              <a onclick="openForm('insurance')" class="btn-buy"><i class="bi bi-plus"></i>  Get your industry specific platform demo</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                <div class="portfolio-links">
                  <button onclick="openForm('mortgage')" type="button" class=""><i class="bi bi-plus"></i> Get your industry specific platform demo</button>
                </div>
              </div>
            </div>
            ...
            <div class="box-feature">
              ...
              <a  onclick="openForm('mortgage')" class="btn-buy"><i class="bi bi-plus"></i>  Get your industry specific platform demo</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                <div class="portfolio-links">
                  <button type="button" onclick="openForm('realstate')" class=""><i class="bi bi-plus"></i> Get your industry specific platform demo</button>
                </div>
              </div>
            </div>
            ...
            <div class="box-feature">
              ...
              <ul>
                ...
                <li>Owners: This will help in giving access to your different employees or agents on restrictive basis.</li>
                <li>Exclusive Listing: This will help in managing your listings or Social Media posts for Marketing purposes.</li>
              </ul>
              <a  onclick="openForm('realstate')" class="btn-buy"><i class="bi bi-plus"></i>  Get your industry specific platform demo</a>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row feture-tabs" data-aos="fade-up">
          <div class="col-lg-6 spacpart">
            ...
            <p>Contacts is your all database collected from YOUR different resources/inputs such as Phone Contacts, Website, Social Medias, Manual Input, Referrals, etc.</p>
